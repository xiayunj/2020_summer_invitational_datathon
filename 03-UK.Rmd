...
In this part of our report, we discuss the impact of the 2012 London Olympics on the UK as a whole, as well as its constituent subregions.     
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.link='https://github.com/xiayunj/2020_summer_invitational_datathon'}
knitr::include_graphics('extra_plots/uk_joy.png', dpi = NA)
```  
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.link='https://github.com/xiayunj/2020_summer_invitational_datathon'}
knitr::include_graphics('extra_plots/uk_regional_pay.png', dpi = NA)
``` 
