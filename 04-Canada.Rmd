...
ggplot(ca_vis[which(ca_vis$GEO == 'Canada'),], aes(as.Date(as.yearmon(REF_DATE)), VALUE/1000000)) + 
  ...
  labs(x = 'Year', y = 'Number of International Tourists in Billions') +
  theme_gray(13)
```
...
```{r echo=FALSE, fig.height=5, fig.width=10, message=FALSE, warning=FALSE}
ggplot(ca_vis1, 
       aes(as.Date(as.yearmon(REF_DATE)), VALUE/1000, color = larger_region)) + 
  geom_line() +
  ggtitle('Canada Regional Average International Tourists', subtitle = 'From 2000 to 2018') +
  labs(x = 'Year', y = 'Average Number of International Tourists in Thousands') +
  theme_gray(13)
```
