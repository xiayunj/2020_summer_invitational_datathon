...
<font size="6"><b> Analysis of Economic impacts on Canada hosting Olympics by Regions </b></font>     
...
<font size="5"><b> Canada Regional GDP Increasing Rate from 2007 to 2015 </b></font>    
```{r include=FALSE}
ca_gdp_rate_temp <- ca_gdp1[31:80,]
ca_gdp_rate <- data.frame('Year' = c('2007','2008','2009','2010','2011','2012','2013','2014','2015'))
```
...
for (i in 2007:2015){
  for (j in c('The Atlantic Provinces','Central Canada','The Prairie Provinces',
      ...
      ca_gdp_rate[i-2006, j] <- round(as.numeric(
...
<font size="5"><b> Canada Regional Household Income Per Capita Increasing Rate from 2007 to 2015 </b></font>    
```{r echo=FALSE}
ca_in_rate_temp <- ca_in1[31:80,]
ca_in_rate <- data.frame('Year' = c('2007','2008','2009','2010','2011','2012','2013','2014','2015'))
```
...
for (i in 2007:2015){
  for (j in c('The Atlantic Provinces','Central Canada','The Prairie Provinces',
              'The West Coast','The Northern Territories')){
      ca_in_rate[i-2006, j] <- round(as.numeric(
...
<font size="5"><b> Canada Regional Unemployment Rate Increasing Rate from 2007 to 2015 </b></font>    
```{r include=FALSE}
ca_un_rate_temp <- ca_un1[31:80,]
ca_un_rate <- data.frame('Year' = c('2007','2008','2009','2010','2011','2012','2013','2014','2015'))
```
...
for (i in 2007:2015){
  for (j in c('The Atlantic Provinces','Central Canada','The Prairie Provinces',
              'The West Coast','The Northern Territories')){
      ca_un_rate[i-2006, j] <- round(as.numeric(
